                ...
                submitHandler: function (h) {
                    ...
                    $.post($(".login-form").attr('action'), {
                        ...
                        if (data.status == 0) {
                            ...
                            $('.login-form .form-title').after('<div class="alert fade in alert-danger"><i class="icon-remove close" data-dismiss="alert"></i>'+ data.msg +'</div>');
                        }
                    }, 'json');
                }
            })
                ...
                submitHandler: function (h) {
                    ...
                    $.post($(".register-form").attr('action'), {
                        ...
                        if (data.status == 0) {
                            ...
                            $('.register-form .alert-danger').remove();
                            $('.register-form .form-title').after('<div class="alert fade in alert-danger"><i class="icon-remove close" data-dismiss="alert"></i>'+ data.msg +'</div>');
                        }
                    }, 'json');
                }
            })
